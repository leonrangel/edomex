define( function( require, exports, module ) {
  ...
  // Set debug ID
  var debug = require( 'debug' )( 'module:admin:tournament:views:matchResultsFinal' );
  ...
  var MatchResults = Valkie.View.extend({
    template: Valkie.template( require( 'text!./templates/matchResultsFinal.hbs' ) ),
    ...
    initialize: function( options ) {
      ...
      this.playersA.url = '/team/' + options.match.attributes.teamA._id + '/members';
      this.playersA.fetch( { async: false } );

      // Retrieve players for teamB
      this.playersB = new UsersCollection();
      this.playersB.url = '/team/' + options.match.attributes.teamB._id + '/members';
