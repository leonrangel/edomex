define( function( require, exports, module ) {
  ...
  // Set debug ID
  var debug = require( 'debug' )( 'module:site:league:views:header' );
  
  // Module dependencies
  var Valkie = require( 'valkie' );
  
  // View definition
  var LeagueHeader = Valkie.View.extend({
    ...
    markActive: function( tab ) {
      this.ui.nav.parent().removeClass( 'active' );
      this.ui.nav.filter( "[href='"+tab+"']" ).parent().addClass( 'active' );
    },
